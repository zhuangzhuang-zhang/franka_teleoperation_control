...
franka_driver::franka_driver(std::string robot_ip,int mode)
    : as_(n_,"follow_joint_trajectory",boost::bind(&franka_driver::executeCB, this, _1), false){
    mode_ = mode;
...
void franka_driver::state_pub_thread_func(){
    ...
    robot_states_pub_ = n_.advertise<franka_msgs::FrankaState>("franka_state",1);
    ...
    while(ros::ok()){
        ...
        joint_states_msg.name[0] = "panda_joint1";
        joint_states_msg.name[1] = "panda_joint2";
        joint_states_msg.name[2] = "panda_joint3";
        joint_states_msg.name[3] = "panda_joint4";
        joint_states_msg.name[4] = "panda_joint5";
        joint_states_msg.name[5] = "panda_joint6";
        joint_states_msg.name[6] = "panda_joint7";
